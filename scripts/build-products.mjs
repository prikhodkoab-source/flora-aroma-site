...
function expandedTexts({ card, name, latinName, publicCategoryName, container, summary }) {
  ...
  return {
    ecology_text: selected.ecology,
    agrotechnics_text: selected.agrotechnics,
    use_text: selected.use,
    full_description: `${selected.ecology} ${selected.agrotechnics} ${selected.use}`,
