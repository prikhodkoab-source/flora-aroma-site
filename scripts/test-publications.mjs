...
assert.match(
  gardenFashionDraft,
  /subtitle:\s*"Чому на зміну формальним квітникам приходять злаки, ароматичні трави, посухостійкі багаторічники та рослини для запилювачів"/
);
...
for (const plantId of ["PLANT-0009", "PLANT-0085", "PLANT-0087"]) {
